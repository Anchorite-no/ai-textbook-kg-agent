...
export const apiMode = {
  ...
  graph: pick(import.meta.env.VITE_API_GRAPH, "mock"),
  integration: pick(import.meta.env.VITE_API_INTEGRATION, "mock"),
  rag: pick(import.meta.env.VITE_API_RAG, "mock"),
  dialogue: pick(import.meta.env.VITE_API_DIALOGUE, "mock"),
